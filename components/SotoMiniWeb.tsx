...
{/* 4. MINI ABOUT SECTION (SUDAH DIGANTI PAKAI SOTO_4.JPG) */}
      <div className="grid grid-cols-2 gap-2 pt-1 items-center">
        <div className="rounded-lg h-20 relative overflow-hidden border border-[#D4731A]/15 shadow-3xs bg-[#FEF0D8]">
          {/* FOTO SOTO 4 ASLI MASUK SINI */}
          <img 
            src="/soto_4.jpg" 
            alt="Kisah Soto Pak Bejo" 
            className="w-full h-full object-cover"
          />
          {/* Badge 37 Tahun Tetap Dipertahankan di Pojok Kanan Bawah */}
        ...
        <div className="space-y-1">
          ...
          <p className="text-[#7A5C3A] text-[6px] leading-relaxed">
            Soto Lamongan Pak Bejo hadir dengan resep autentik tiga generasi menggunakan ayam kampung segar.
          </p>
        </div>
      </div>

      {/* 5. MINI MENU SECTION (FOTO SEKARANG SUDAH MASUK KESINI SEMUA) */}
        ...
        <div className="space-y-2">
          ...
          <div className="bg-[#FFFBF3] border border-[#D4731A]/18 rounded-md p-1.5 flex items-center justify-between gap-2 shadow-3xs relative">
            ...
            <div className="flex items-center gap-2">
              {/* Tempat Foto Produk 1 */}
              <img 
                src="/soto_1.jpg" 
                alt="Soto Spesial" 
                className="w-10 h-10 object-cover rounded-md border border-[#D4731A]/10 flex-shrink-0"
              />
              <div>
                <p className="font-serif font-bold text-[#3E1F05] text-[7.5px]">Soto Lamongan Spesial</p>
                <p className="text-[#7A5C3A] text-[6px] leading-tight mt-0.5">Kuah kaldu ayam kampung asli, suwiran ayam, & koya melimpah.</p>
              </div>
            </div>
            <div className="text-right flex-shrink-0 pl-1">
              <p className="font-serif font-bold text-[#D4731A] text-[8px]">Rp 18.000</p>
              <span className="inline-block bg-[#3E1F05] text-white px-1 py-0.5 rounded-full text-[4.5px] mt-1 font-bold shadow-3xs">+ Pesan</span>
            </div>
          </div>

          {/* Menu 2 - Pakai soto_2.jpg */}
          <div className="bg-[#FFFBF3] border border-[#D4731A]/18 rounded-md p-1.5 flex items-center justify-between gap-2 shadow-3xs">
            <div className="flex items-center gap-2">
              {/* Tempat Foto Produk 2 */}
              <img 
                src="/soto_2.jpg" 
                alt="Soto Telur" 
                className="w-10 h-10 object-cover rounded-md border border-[#D4731A]/10 flex-shrink-0"
              ...
              <div>
                ...
                <p className="text-[#7A5C3A] text-[6px] leading-tight mt-0.5">Versi ringan dipadu dua butir telur rebus, tauge, dan bihun.</p>
              </div>
            </div>
            <div className="text-right flex-shrink-0 pl-1">
          ...
          {/* Menu 3 - Pakai soto_3.jpg */}
          <div className="bg-[#FFFBF3] border border-[#D4731A]/18 rounded-md p-1.5 flex items-center justify-between gap-2 shadow-3xs">
            <div className="flex items-center gap-2">
              {/* Tempat Foto Produk 3 */}
              <img 
                src="/soto_3.jpg" 
                alt="Soto Komplit Jumbo" 
                className="w-10 h-10 object-cover rounded-md border border-[#D4731A]/10 flex-shrink-0"
              />
              <div>
                <p className="font-serif font-bold text-[#3E1F05] text-[7.5px]">Soto Komplit Jumbo</p>
                <p className="text-[#7A5C3A] text-[6px] leading-tight mt-0.5">Porsi besar mantap dengan ayam goreng utuh, jeroan, & koya ekstra.</p>
              </div>
            </div>
            <div className="text-right flex-shrink-0 pl-1">
      ...
      {/* 6. MINI TESTIMONIAL SECTION */}
      <div className="bg-[#FDF3E3] p-2 rounded-lg border border-[#D4731A]/10 space-y-1.5">
        <div className="bg-white p-2 rounded-md border border-[#D4731A]/10 shadow-3xs text-center">
          <div className="text-[#F5C06A] text-[6px] tracking-xs mb-0.5">★★★★★</div>
          <p className="text-[#7A5C3A] text-[6px] italic leading-relaxed">
            "Kuahnya gurih banget, koyanya berlimpah. Sudah 10 tahun saya langganan di sini, rasanya konsisten!"
          </p>
          <p className="font-bold text-[#3E1F05] text-[5.5px] mt-1">👩 Ibu Rina (Surabaya)</p>
        </div>
      </div>
